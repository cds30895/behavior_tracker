...
CREATE TABLE public.behaviors (
    ...
    date_of_behavior date DEFAULT CURRENT_DATE,
...
COPY public.activities (id, type) FROM stdin;
...
1	12345	\N	\N	\N	2023-09-14	09:00:00	14:00:00
2	34012	\N	\N	\N	2023-09-13	10:28:00	10:30:00
\.
...
COPY public.settings (id, location) FROM stdin;
1	GenEd Classroom
2	SpEd Classroom
3	Specialist
4	Hallway
...
SELECT pg_catalog.setval('public.behaviors_id_seq', 2, true);
...
--
-- Name: activities activities_type_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.activities
    ADD CONSTRAINT activities_type_key UNIQUE (type);
...
--
-- Name: settings settings_location_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.settings
    ADD CONSTRAINT settings_location_key UNIQUE (location);
...
--
-- Name: behaviors_activities fk_behaviors_activities_activities; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_activities
    ADD CONSTRAINT fk_behaviors_activities_activities FOREIGN KEY (activity_id) REFERENCES public.activities(id);


--
-- Name: behaviors_activities fk_behaviors_activities_behaviors; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_activities
    ADD CONSTRAINT fk_behaviors_activities_behaviors FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: behaviors_antecedents fk_behaviors_antecedents_antecedents; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_antecedents
    ADD CONSTRAINT fk_behaviors_antecedents_antecedents FOREIGN KEY (antecedent_id) REFERENCES public.antecedents(id);


--
-- Name: behaviors_antecedents fk_behaviors_antecedents_behaviors; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_antecedents
    ADD CONSTRAINT fk_behaviors_antecedents_behaviors FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: behaviors_behavior_desc fk_behaviors_behavior_desc_behavior_desc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_behavior_desc
    ADD CONSTRAINT fk_behaviors_behavior_desc_behavior_desc FOREIGN KEY (behavior_desc_id) REFERENCES public.behavior_desc(id);


--
-- Name: behaviors_behavior_desc fk_behaviors_behavior_desc_behaviors; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_behavior_desc
    ADD CONSTRAINT fk_behaviors_behavior_desc_behaviors FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: behaviors_consequences fk_behaviors_consequences_behaviors; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_consequences
    ADD CONSTRAINT fk_behaviors_consequences_behaviors FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: behaviors_consequences fk_behaviors_consequences_consequences; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_consequences
    ADD CONSTRAINT fk_behaviors_consequences_consequences FOREIGN KEY (consequence_id) REFERENCES public.consequences(id);


--
-- Name: behaviors_settings fk_behaviors_settings_behaviors; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_settings
    ADD CONSTRAINT fk_behaviors_settings_behaviors FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: behaviors_settings fk_behaviors_settings_settings; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_settings
    ADD CONSTRAINT fk_behaviors_settings_settings FOREIGN KEY (setting_id) REFERENCES public.settings(id);


--
-- Name: behaviors fk_behaviors_students; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors
    ADD CONSTRAINT fk_behaviors_students FOREIGN KEY (student) REFERENCES public.students(student_id);


--
-- Name: behaviors_subjects fk_behaviors_subjects_behaviors; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_subjects
    ADD CONSTRAINT fk_behaviors_subjects_behaviors FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: behaviors_subjects fk_behaviors_subjects_subjects; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.behaviors_subjects
    ADD CONSTRAINT fk_behaviors_subjects_subjects FOREIGN KEY (subject_id) REFERENCES public.subjects(id);


--
-- Name: observing_staff fk_observing_staff_behavior_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.observing_staff
    ADD CONSTRAINT fk_observing_staff_behavior_id FOREIGN KEY (behavior_id) REFERENCES public.behaviors(id);


--
-- Name: observing_staff fk_observing_staff_staff_present; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.observing_staff
    ADD CONSTRAINT fk_observing_staff_staff_present FOREIGN KEY (staff_present) REFERENCES public.staff(id);


--
-- Name: students fk_students_staff; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT fk_students_staff FOREIGN KEY (case_manager) REFERENCES public.staff(id);
